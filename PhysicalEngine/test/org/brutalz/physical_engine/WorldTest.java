...
public class WorldTest {
    ...
    public void testSphereFreeFalling() {
        ...
        assertEquals(0.0, sphere.getCenter().getX(), 0.0001);
        assertEquals(0.0, sphere.getCenter().getY(), 0.0001);
        assertEquals(5.0, sphere.getCenter().getZ(), 0.0001); // z = z0 + V0*t + a*t^2/2
    }
    ...
    public void testSphereJumpingOnPlane() {
        ...
        assertEquals(10.0, sphere.getCenter().getZ(), 0.0001);
    }
}
